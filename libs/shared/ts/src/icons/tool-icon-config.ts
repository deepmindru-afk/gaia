...
export const toolIconConfigs: Record<string, ToolIconConfig> = {
  ...
  // Desktop-executed tools (GAIA desktop app). The category entry covers
  // the tool thread's stacked icons; the per-tool entries give the loading
  // indicator an accurate icon for each action.
  desktop: {
    icon: "ComputerIcon",
    bgColor: "bg-sky-500/20 backdrop-blur",
    iconColor: "text-sky-400",
