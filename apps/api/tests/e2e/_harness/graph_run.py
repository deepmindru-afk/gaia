...
async def run_graph(
    ...
    *,
    ...
    configurable adds the identity keys a tool reads beyond thread/user
    (stream_id, conversation_id, the run's provenance).
    """
    ...
    config = {
        "configurable": {"thread_id": thread_id, "user_id": user_id, **(configurable or {})},
