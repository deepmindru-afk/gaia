...
- The browser sees only the task text you write: not this conversation, not your memory. Put every value the site will ask for into the task (names, email, address, dates, quantities, the exact item), and ask the user first when a value it cannot do without is unknown. It never invents one.
