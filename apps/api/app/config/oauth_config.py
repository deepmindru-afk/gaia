...
from app.agents.prompts.subagent_prompts import (
    ...
    HACKERNEWS_AGENT_SYSTEM_PROMPT,
    HUBSPOT_AGENT_SYSTEM_PROMPT,
    INSTACART_AGENT_SYSTEM_PROMPT,
...
OAUTH_INTEGRATIONS: list[OAuthIntegration] = [
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            auto_bind_tools=[
                ...
                "GOOGLEDOCS_REPLACE_ALL_TEXT_IN_DOCUMENT",
                "GOOGLEDOCS_UPDATE_DOCUMENT_MARKDOWN",
                "GOOGLEDOCS_COPY_GOOGLE_DOCUMENT",
            ],
    ...
    OAuthIntegration(
        id="skills",
        name="Skills",
        description="Install, create, and manage agent skills from GitHub or inline",
        category="productivity",
        provider="skills",
        scopes=[],
        available=True,
        ...
        subagent_config=SubAgentConfig(
            ...
            tool_space="skills",
            handoff_tool_name="call_skills_agent",
            domain="agent skill management and configuration",
            capabilities="installing skills from GitHub, creating custom skills inline, listing installed skills, enabling/disabling skills, uninstalling skills, managing skill scopes and targets",
            use_cases="installing agent skills, creating custom procedures, managing installed skills, or any skill-related task",
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            auto_bind_tools=[
                ...
                "MICROSOFT_TEAMS_LIST_TEAM_CHANNELS",
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            system_prompt=HACKERNEWS_AGENT_SYSTEM_PROMPT,
            use_direct_tools=True,
            disable_retrieve_tools=True,
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            system_prompt=INSTACART_AGENT_SYSTEM_PROMPT,
            use_direct_tools=True,
            disable_retrieve_tools=True,
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            system_prompt=YELP_AGENT_SYSTEM_PROMPT,
            use_direct_tools=True,
            disable_retrieve_tools=True,
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            system_prompt=AGENTMAIL_AGENT_SYSTEM_PROMPT,
            use_direct_tools=True,
            disable_retrieve_tools=True,
