...
## [0.26.0](https://github.com/theexperiencecompany/gaia/compare/web-v0.25.0...web-v0.26.0) (2026-09-24)
...
* **web:** enable PostHog session replay with explicit session_recording block ([#1216](https://github.com/theexperiencecompany/gaia/issues/1216)) ([d914063](https://github.com/theexperiencecompany/gaia/commit/d9140635b399223c05c29611200e1b4340012e3f))
* **web:** name the company in the footer and stop the fade covering the headings ([#1192](https://github.com/theexperiencecompany/gaia/issues/1192)) ([de5b8fc](https://github.com/theexperiencecompany/gaia/commit/de5b8fc6220f6f2ddae109fbba16552c0706dacc))
...
* **web:** reset canvas.md cache when the selected todo changes ([#1179](https://github.com/theexperiencecompany/gaia/issues/1179)) ([d07e605](https://github.com/theexperiencecompany/gaia/commit/d07e605e3997de57997109ec104fa5bd3a4158b9))
...
* **web:** expand toasts on hover only ([#853](https://github.com/theexperiencecompany/gaia/issues/853)) ([e8661c7](https://github.com/theexperiencecompany/gaia/commit/e8661c7d17154f3805900907398b54f20f749ceb))
...
* implement responsive design for landing and pricing pages ([#779](https://github.com/theexperiencecompany/gaia/issues/779)) ([4b5a5a2](https://github.com/theexperiencecompany/gaia/commit/4b5a5a2ed24f295166111c4397ce43c4616055e0))
* **landing:** truncate memory bento caption to one line ([#769](https://github.com/theexperiencecompany/gaia/issues/769)) ([863b028](https://github.com/theexperiencecompany/gaia/commit/863b0282a7684db4157e8547f04d14961896fdb9))
...
* **web:** resolve Ahrefs SEO audit issues ([#761](https://github.com/theexperiencecompany/gaia/issues/761)) ([1e75e6b](https://github.com/theexperiencecompany/gaia/commit/1e75e6bad7d7a88dade219409d88bf17ac827275))

## [0.20.0](https://github.com/theexperiencecompany/gaia/compare/web-v0.19.0...web-v0.20.0) (2026-06-14)
...
## [0.19.0](https://github.com/theexperiencecompany/gaia/compare/web-v0.18.0...web-v0.19.0) (2026-06-12)
...
* **web:** add Rybbit analytics with deferred load ([#721](https://github.com/theexperiencecompany/gaia/issues/721)) ([be185ec](https://github.com/theexperiencecompany/gaia/commit/be185ec1d7e985d2d66a48e0eb80fb82db54e200))
...
* **web:** make server-side SSG builds compile cleanly ([#722](https://github.com/theexperiencecompany/gaia/issues/722)) ([62fca87](https://github.com/theexperiencecompany/gaia/commit/62fca87e3d8a81130ec02b3b2797b4fd6b4519ca))
* **web:** patch placeholder URL in prerendered HTML + RSC + required-server-files.json ([#718](https://github.com/theexperiencecompany/gaia/issues/718)) ([c8d74f3](https://github.com/theexperiencecompany/gaia/commit/c8d74f32b75dce0f36c2694ae8fc15a966f6189b))
...
* **web:** scope Cloudflare image loader to CF builds so staging/Electron images work ([#745](https://github.com/theexperiencecompany/gaia/issues/745)) ([e85e8c3](https://github.com/theexperiencecompany/gaia/commit/e85e8c37be7077f9151ff79eb8aca63257e1ac1f))
...
* **web:** stop routing remote images through Cloudflare cdn-cgi resizer ([#752](https://github.com/theexperiencecompany/gaia/issues/752)) ([df068f0](https://github.com/theexperiencecompany/gaia/commit/df068f06bfd0b62aeb14133f229acc2ac0ce53e6))
...
* **docs:** Mintlify changelog with comprehensive release notes ([#592](https://github.com/theexperiencecompany/gaia/issues/592)) ([fb75acd](https://github.com/theexperiencecompany/gaia/commit/fb75acd59b2407616e61146a5b5bfc2509065315))
...
* **landing:** /features grid + /features/[slug] — 30 features, 30 animated demos ([#585](https://github.com/theexperiencecompany/gaia/issues/585)) ([e2b089f](https://github.com/theexperiencecompany/gaia/commit/e2b089fc7a282c4998b61650b2145a4dd3db1e71))
...
* **web:** add Open action button to workflow generated toast ([7209316](https://github.com/theexperiencecompany/gaia/commit/72093164e15888f95cbdf1dac2059635568249ed))
...
* **features:** update code execution demo and fix keyboard listener ([#588](https://github.com/theexperiencecompany/gaia/issues/588)) ([d510abe](https://github.com/theexperiencecompany/gaia/commit/d510abe7c42138426e0c4ee461d08d7c666660d8))
...
* **web:** close sidebar reliably when deleting last todo in filtered view ([b801cb1](https://github.com/theexperiencecompany/gaia/commit/b801cb188c8c665754337cd4a8a9777961d5a60e))
...
* minor cli improvements ([#495](https://github.com/theexperiencecompany/gaia/issues/495)) ([9d47723](https://github.com/theexperiencecompany/gaia/commit/9d47723e8fa87f3d5cbffc3f6b596021ce6a5648))
...
* add handling query parameter for deep linking ([#479](https://github.com/theexperiencecompany/gaia/issues/479)) ([1628a48](https://github.com/theexperiencecompany/gaia/commit/1628a48e78eb89eddaaf7d8c67e52af9c7915b75))
...
* **landing:** Add interactive demo sections with chat and workflow showcases ([#472](https://github.com/theexperiencecompany/gaia/issues/472)) ([2218aa4](https://github.com/theexperiencecompany/gaia/commit/2218aa48816cae4e6ed5b9e8c0f79b116588af75))
...
* **seo:** Add FAQ data and SEO enhancements for better discoverability ([#471](https://github.com/theexperiencecompany/gaia/issues/471)) ([7b23c67](https://github.com/theexperiencecompany/gaia/commit/7b23c6712dcf3b268ea7a6a8759525e646f2cfce))
